...
public class BonpreuFinder : AbstractFinder
{
    ...
    private const string UriTemplate =
        ...
        "?includeAdditionalPageInfo=true&maxPageSize=300&maxProductsToDecorate=30&tag=web&q={0}";

    // "https://www.compraonline.bonpreuesclat.cat/api/webproductpagews/v6/product-pages/search?
    // // includeAdditionalPageInfo=true&maxPageSize=300&maxProductsToDecorate=30&q=leche&tag=web"

    public override DTOs.Market GetMarket() => DTOs.Market.BONPREU;
    ...
    {
        // Bonpreu requiere un User-Agent de navegador real, si no devuelve 403
        request.Headers.TryAddWithoutValidation("User-Agent",
            "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Safari/537.36");
        request.Headers.TryAddWithoutValidation("Accept", "application/json");
        request.Headers.TryAddWithoutValidation("Referer", "https://www.compraonline.bonpreuesclat.cat/");
    }
        ...
        foreach (var group in groups.EnumerateArray())
        {
            ...
            foreach (var item in decoratedProducts.EnumerateArray())
            {
                try
                {
                    ...
                    product.Market = DTOs.Market.BONPREU;
